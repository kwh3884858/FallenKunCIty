...
public class JoyStick : MonoBehaviour, IPointerDownHandler, IPointerUpHandler, IDragHandler
{
    ...
    public Vector2 TouchedAxis
    {
        get
        {
            if (touchedAxis.magnitude < JoyStickRadius)
                return touchedAxis / JoyStickRadius;
    ...
    void Start()
    {
        ...
        RectTransform rectTransforms1 = this.transform.parent.GetChild(0).GetComponent<RectTransform>();
        RectTransform rectTransforms2 = this.transform.parent.GetChild(1).GetComponent<RectTransform>();

        JoyStickRadius = (int)((Mathf.Abs(rectTransforms1.localPosition.x - rectTransforms2.localPosition.x) + rectTransforms1.sizeDelta.x)*this.transform.parent.localScale.x/2);
    }
